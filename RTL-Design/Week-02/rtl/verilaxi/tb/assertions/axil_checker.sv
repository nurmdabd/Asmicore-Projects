...
module axil_checker #(
  ...
  property p_awvalid_stable;
    @(posedge clk) disable iff (!rst_n) awvalid && !awready |=> awvalid;
  endproperty
  ...
  property p_wvalid_stable;
    @(posedge clk) disable iff (!rst_n) wvalid && !wready |=> wvalid;
  endproperty
  ...
  property p_bvalid_stable;
    @(posedge clk) disable iff (!rst_n) bvalid && !bready |=> bvalid;
  endproperty
  ...
  property p_arvalid_stable;
    @(posedge clk) disable iff (!rst_n) arvalid && !arready |=> arvalid;
  endproperty
